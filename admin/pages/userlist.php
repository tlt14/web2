                            ...
                            ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="?deletename=<?php //echo $result['tenDangNhap'] 
                                                                            ?>" ><button type="button" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa người dùng này không?');" >Xóa</button></a> -->
                                                <?php
