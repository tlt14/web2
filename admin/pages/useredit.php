                        ...
                        <form action="" method="POST" enctype="multipart/form-data" name="formUser" onsubmit="return validationForm()">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="tenNguoiQuanTri" value="<?php echo $result_user['TenKhachHang'] ?>" class="inputAddProduct" autofocus>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="email" name="thuDienTuQT" value="<?php echo $result_user['Email'] ?>" class="inputAddProduct">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="inputAddProduct" name="maVaiTro" required>
                                            ...
                                            ?>
                                                    <option <?php
                                                            if ($result_type['MaVaiTro'] == $result_user['VaiTro']) {
                                                                echo 'selected';
                                                            }
