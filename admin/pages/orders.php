                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php echo $resultDH['NgayDat']; ?></td>
                                                <td><?php echo number_format($resultDH['TongTien']); ?> VND</td>
                                                <td>
                                                    <?php
                                                    if ($resultDH['TrangThai'] == "1") {
                                                        echo "<button type='button' class='btn btn-outline btn-warning'>Chưa giao</button>";
                                                    } else if ($resultDH['TrangThai'] == "4") {
                                                        echo "<button type='button' class='btn btn-outline btn-success'>Đã hoàn thành</button>";
                                                    }
                                                    else if ($resultDH['TrangThai'] == "5") {
                                                        echo "<button type='button' class='btn btn-outline btn-danger'>Đã hủy</button>";
                                                    }else
                                                    if ($resultDH['TrangThai'] == "2") {
                                                        echo "<button type='button' class='btn btn-outline btn-primary'>Đã hủy</button>";
                                                    }
                                                    else
                                                    if ($resultDH['TrangThai'] == "3") {
                                                        echo "<button type='button' class='btn btn-outline btn-secondary'>Đã hủy</button>";
                                                    }
                                                    ?>
                                                </td>
