                            ...
                            <form action="" method="POST" enctype="multipart/form-data" name="formUser" onsubmit="return validationForm()">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 style="font-size: 16px;"><?php echo $resultDH['SDTNguoiNhan'] ?></h5>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 style="font-size: 16px;">+84<?php echo $resultDH['DiaChiNguoiNhan'] ?></h5>
                                        </td>
                                    </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td><?php echo $i; ?></td>
                                                            <td><img src="uploads/<?php echo $resultSPDH['HinhAnhSanPham']; ?>" width="80"></td>
                                                            ...
                                                            <td>
                                                                <?php 
                                                                // echo $resultSPDH['sum(`SoLuongSP`)']; 
                                                                ?></td>
                                                            <td><?php echo number_format($resultSPDH['GiaSanPham']); ?></td>

                                                            <?php
                                                            $thanhtien = $resultSPDH['SoLuongSP'] * $resultSPDH['GiaSanPham'];
                                                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font-size: 16px;"><?php echo number_format($resultDH['TongTien']) ?> VND</span>
                                        </td>
                                    </tr>
                                    <td class="tabLabel">
                                        <label class="labelAddProduct"> Trạng thái đơn hàng: </label>
                                        <span style="font-size: 16px;"><?php echo $resultDH['TenTrangThai'] ?></span>
                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font-size: 16px;"><?php echo $resultDH['GhiChu'] ?></span>
                                        </td>
                                    </tr>
