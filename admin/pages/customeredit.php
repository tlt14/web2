                        ...
                        ?>
                            <form action="" method="POST" enctype="multipart/form-data" name="formUser" onsubmit="return validationForm()"> <!--enctype để có thể thêm hình ảnh -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="hoTenKhachHang" value="<?php echo $result_customer['TenKhachHang'] ?>" class="inputAddProduct" autofocus>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="email" name="thuDienTuKH" value="<?php echo $result_customer['Email'] ?>" class="inputAddProduct" >
                                    </td>
                                </tr>
