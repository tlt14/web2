                        ...
                        ?>
                            <form action="" method="POST" enctype="multipart/form-data" name="formUser" onsubmit="return validationForm();"> <!--enctype để có thể thêm hình ảnh -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="inputAddProduct" name="maLoai" required>
                                            ...
                                            <option 
                                            <?php 
                                                if ($result['MaLoai'] == $result_prod['LoaiSanPham'] ){ echo 'selected'; }
                                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="soLuongSanPham" min=0 max=9999 value="<?php echo $result_prod['SoLuongSanPham'] ?>" class="inputAddProduct" required>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <textarea name="mieuTaSanPham" rows="2" cols="25" class="inputAddProduct" style="height: 80px;" required><?php echo $result_prod['MoTaSanPham'] ?></textarea>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <input type="number" name="giaSanPham" min=1000 max=1000000000 value="<?php echo $result_prod['GiaSanPham'] ?>" class="inputAddProduct" required>
                                    </td>
                                </tr>
