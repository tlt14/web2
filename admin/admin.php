        ...
        if (isset($_POST['editProduct-btn'])) {
            ...
            if ($_FILES['productimg']['name'] != '') {
                ...
                if ($productname == '' || $productquantity == ''  || $productdescription == '' || $productprice == '') {
                    ...
                    $sql = "UPDATE tbl_sanpham SET TenSanPham = '$productname', SoLuongSanPham ='$productquantity', MoTaSanPham ='$productdescription', GiaSanPham ='$productprice', LoaiSanPham = '$producttype' where MaSanPham = $id";
                    $query = mysqli_query($conn, $sql);
                }
            }
        }
